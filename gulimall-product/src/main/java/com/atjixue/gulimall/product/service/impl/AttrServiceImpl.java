...
import com.atjixue.gulimall.product.dao.AttrAttrgroupRelationDao;
...
import com.atjixue.gulimall.product.dao.AttrDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public void deleteRelation(AttrGroupRelationVo[] vos) {
         ...
         *          只发一次删除请求，批量删除
         *         elete from pms_attr_attrgroup_relation where (attr_id = ? and attr_group_id = ?)
    ...
    public PageUtils getNoRelationAttr(Map<String, Object> params, long attrgroupId) {
        ...
        QueryWrapper<AttrEntity> wrapper = new QueryWrapper<AttrEntity>().eq("catelog_id",
