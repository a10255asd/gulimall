package com.atjixue.gulimall.cart.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.atjixue.common.utils.R;
import com.atjixue.gulimall.cart.feign.ProductFeignService;
...
import com.atjixue.gulimall.cart.vo.SkuInfoVo;
 ...
 * @Author LiuJixue
 * @Date 2022/9/2 16:50
 * @PackageName:com.atjixue.gulimall.cart.service.impl
...
public class CartServiceImpl implements CartService {
    ...
    public Cart getCart() throws ExecutionException, InterruptedException {
        ...
        if (userInfoTo.getUserId() != null) {
            ...
            // 3、获取登录后的数据,包含合并过来的临时购物车的数据 和登录后的购物车的数据
    ...
    public List<CartItem> getUserCartItems() {
        ...
        if (userInfoTo.getUserId() == null) {
            ...
            String cartKey = CART_PREFIX + userInfoTo.getUserId();
            // 获取所有被选中的购物项
            List<CartItem> collect = getCartItems(cartKey).stream().filter((item)
